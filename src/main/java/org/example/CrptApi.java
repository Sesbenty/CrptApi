...
public class CrptApi {
    ...
    public class RateLimiter {
        ...
        private final ScheduledExecutorService shedule;
        ...
        public RateLimiter(TimeUnit timeUnit, int requestLimit) {
            ...
            this.shedule = Executors.newScheduledThreadPool(1);
            this.requestLimit = requestLimit;
        }

        public void await() throws InterruptedException {
            semaphore.acquire();
            shedule.schedule(() -> semaphore.release(), 1, timeUnit);
        }
    ...
    public class CrptDocument {
        ...
        public CrptDescription getDescription() {
            return description;
        }

        public void setDescription(CrptDescription description) {
        ...
        public List<CrptProduct> getProducts() {
            return products;
        }

        public void setProducts(List<CrptProduct> products) {
